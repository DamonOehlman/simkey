...
test('can simulate a keypress in an element', function(t) {
  t.plan(1);
  ...
  simkey(testTarget, 65);
});

test('can perform partial application of simkey', function(t) {
  var keys = [65, 67];
  var sendKey;
